...
const Orders = () => {
    ...
    const showStatus =  o=>{
        return(
            <div>
                ...
                <select className='bg-red-300 text-black'
  ...
  return (
    <Layout title='Order' description={`Look what you got ordered today`}>  
        ...
        {
        <div className='w100 flex justify-center bg-orange-500 '>
            ...
            orders.length > 0 && orders.map((o,i)=>{
                return(
                    <div key={i} className={`flex-col m-2 bg-gray-400 text-white breaktext`}>
                        ...
                        <p className='w100 border-2 border-black text-2xl font-black '>Transaction Id : {o.transactionId}</p>
